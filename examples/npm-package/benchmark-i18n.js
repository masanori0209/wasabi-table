...
export const messages = {
  en: {
    ...
    'footnote':
      'Results vary by device, browser, and load. Scroll FPS uses wheel events on a 1,000×20 grid. Memory is shown only when performance.memory is available (Chromium).',
  ...
  ja: {
    ...
    'footnote':
      '結果は端末・ブラウザ・負荷により変動します。スクロール FPS は 1,000×20 グリッドへのホイール操作で計測。メモリは performance.memory が使える Chromium のみ表示します。',

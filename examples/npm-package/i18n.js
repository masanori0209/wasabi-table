...
export const messages = {
  en: {
    ...
    'hint.filterHeader': 'Click column header left area to select column; click ▾ on the right for sort/filter',
    'tab.headers': 'Headers',
  ...
  ja: {
    ...
    'hint.filterHeader': '列ヘッダー左側で列選択、右端の ▾ でソート・フィルターダイアログを開きます',
    'tab.headers': 'ヘッダー設定',

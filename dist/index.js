...
export class WasabiTable {
    ...
    `;
        // 検索可能な場合は検索ボックスを追加
        if (config === null || config === void 0 ? void 0 : config.searchable) {
      ...
      max-height: ${(config === null || config === void 0 ? void 0 : config.maxDisplayItems) ? config.maxDisplayItems * 32 : 160}px;
      overflow-y: auto;
    `;
        // オプションを追加
